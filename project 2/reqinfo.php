            ...
            <nav>
                <ul class="navb">
                    ...
                    if ($_SESSION['role'] == 'Employee') {
                        echo '<li><a href="EMP_page.php?emp_num=' . $emp_id . '" accesskey="h"> Employee Home </a></li>';
                        ?>
                        <li><a href="aboutUS.php?role=Employee&emp_num=<?php echo $emp_id ?>"accesskey="a">About us</a></li>
                        <li><a href="help.php?role=Employee&emp_num=<?php echo $emp_id ?>" accesskey="q">Help</a> </li>
                        <?php
                    } else
                    if ($_SESSION['role'] == 'manager') {
                        ...
                        ?>
                        <li><a href="aboutUS.php?role=Manager&id=<?php echo $manID ?>"accesskey="a">About us</a></li>
                        <li><a href="help.php?role=Manager&id=<?php echo $manID ?>" accesskey="q">Help</a> </li>
                        <?php
                    }
                    ?>
