...
<html>
    ...
    <body>
        <header>
            <nav>
                <ul class="navb">
                    <li><a href="EMP_page.php?emp_num=<?php echo $emp_id ?>" accesskey="h"> Employee Home </a></li>
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="Emp_page.php?emp_num=<?php echo $emp_id?> "> Employee Home</a></li>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($_POST['sertyp']) || empty($_POST['dscrp']) || !(is_uploaded_file($_FILES["fileToUpload1"]["tmp_name"])) || !(is_uploaded_file($_FILES["fileToUpload2"]["tmp_name"])))
        ...
        function canupload($fileType) {
            ...
            if (in_array(strtolower($fileType), $allowedFile))
                return true;
            else
              return false;
        }
