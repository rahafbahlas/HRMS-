		...
		<header>
			<nav>
				<ul class="navb">
					...
					<li><a href="aboutUS.php?role=Employee&emp_num=<?php echo $_SESSION['emp_num'] ?>"accesskey="a">About us</a></li>
                    <li><a href="help.php?role=Employee&emp_num=<?php echo $_SESSION['emp_num'] ?>" accesskey="q">Help</a> </li>
